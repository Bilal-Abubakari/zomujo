...
function Drawer({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Root>): JSX.Element {
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>): JSX.Element {
  return (
    <div
...
function DrawerFooter({ className, ...props }: React.ComponentProps<'div'>): JSX.Element {
  return (
    <div
