  ...
  return (
    <nav className={cn('flex items-center', className)}>
      <Button
        ...
        child={<ChevronLeft className="h-4 w-4" />}
      />
      <Button
        variant="outline"
        ...
        child={<ChevronRight className="h-4 w-4" />}
      />
    </nav>
  );
}
...
function CaptionLabel({
  ...
  return (
    <Button
      ...
      child={navView === 'days' ? children : displayYears.from + ' - ' + displayYears.to}
    />
  );
}
