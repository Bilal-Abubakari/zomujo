...
>(
  (
    ...
    const [openControl, setOpenControl] = useState(defaultOpen);
    const open = openProp ?? openControl;
    ...
    const contextValue = useMemo<SidebarContext>(
      ...
      [setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar],
    );
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer text-sidebar-foreground me:block hidden"
        data-state={state}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          'text-sidebarLabel ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-0 text-sm font-medium outline-hidden transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2  overflow-hidden rounded-md   pl-[12px] text-left text-sm font-medium text-sidebarMenu outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 before:absolute before:bottom-0 before:left-[-16px] before:top-0 before:w-[5px] before:rounded-l before:rotate-180 before:bg-primary before:opacity-0 before:z-10 data-[active=true]/menu-action:before:opacity-100',
  {
    variants: {
      variant: {
